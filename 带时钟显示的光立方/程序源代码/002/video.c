...
uchar idata display[8][8];

/*rank:A,1,2,3,4,I,心,U*/

uchar code table_cha[8][8]={0x51,0x51,0x51,0x4a,0x4a,0x4a,0x44,0x44,
							...
							0x00,0x3c,0x7e,0x66,0x66,0x66,0x66,0x66,
							};
uchar code flash[18]={6,1,2,3,3,5,4,6,7,8,0,9,8,5,6,7,8,9};
/*the "ideasoft"*/// 1金字塔 2面移动 3斜面  4下雨 5半面 6i*u
					//7面旋转  8四方体    9波浪 
...

{
		...
		{
		/*	ir();
			if(ircode[2]==0x0c)i=1;
			if(ircode[2]==0x18)i=2;
			if(ircode[2]==0x5e)i=3;
			if(ircode[2]==0x08)i=4;
			if(ircode[2]==0x1c)i=5;
			if(ircode[2]==0x5a)i=6;
			if(ircode[2]==0x42)i=7;
			if(ircode[2]==0x52)i=8;
			if(ircode[2]==0x4a)i=9;
			if(ircode[2]==0x46)break;  */

	
			if(num>=18)num=0;
			switch(flash[num])
			{
				case 1:flash_2();clear (0);break;
				case 2:flash_3();clear (0);break;
				case 3:flash_4();clear (0);break;
				case 4:flash_6();clear (0);break;
				case 5:flash_7();clear (0);break;
				case 6:flash_8();clear (0);break;
				case 7:flash_9();clear (0);break;
				case 8:flash_10();clear (0);break;
				case 9:flash_11();clear (0);break;
				default:clear (0);
			}
			num++;
		}
